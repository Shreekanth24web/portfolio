...
function Projects() {
    return (
        <div className="container p-5 mt-5 projects" id='projects'>
            <h1 className=' mb-5 mt-5 text-center text-head' >
                <button className='fs-3'>PROJECTS</button>
            </h1>
            <div className="row mt-5 projects-cards">
                ...
                <div className="card-body mb-4">
                    <a href="https://shreekanth24web.github.io/React-E-commerce-site/" target='_blank'>
                        <img src={shop} alt="shop_img_Error" />
                        <p>
                ...
                <div className="card-body mb-4">
                    <a href="https://shreekanth24web.github.io/Book-store-register-data/" target='_blank'>
                        <img src={bookStore} alt="bookStore_img_Error" />
                        <p>
                ...
                <div className="card-body mb-4">
                    <a href="https://shreekanth24web.github.io/Turn-ON-Off-blub/" target='_blank'>
                        <img src={bulb} alt="bulb_img_Error" />
                        <p>
                ...
                <div className="card-body mb-4">
                    <a href="https://shreekanth24web.github.io/Employe-Data-Table-01/" target='_blank'>
                        <img src={employee} alt="employee_img_Error" />
                        <p>
                ...
                <div className="card-body mb-4">
                    <a href="https://shreekanth24web.github.io/To-do-App/" target='_blank'>
                        <img src={todo} alt="todo_img_Error" />
                        <p>
